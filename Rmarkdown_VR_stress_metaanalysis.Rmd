...
gs4_deauth()
VR_study_sprdsht <- read_sheet("https://docs.google.com/spreadsheets/d/113KZYiODuhNoohl2VNSJcs1sUsDmpp_5mnv5egAPHW4/edit?usp=sharing", range = "Outcomes - Consensus!A2:CU37")
...
dat <-escalc(measure="SMCC", ni=cort_n2i, m1i=cort_m1i, m2i=cort_m2i, sd1i=cort_sd1i, sd2i=cort_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
text(c(-9.5,-8,-6,-4.5, -2.5), 13, c("M", "SD", "M", "SD", "N")) #6 denotes the height,posy
text(c(-8.75,-5.25),     14, c("Baseline", "Peak"))
...
dat <-escalc(measure="SMCC", ni=HR_n1i, m1i=HR_m1i, m2i=HR_m2i, sd1i=HR_sd1i, sd2i=HR_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
forest(res,xlim=c(-20,6), 
       ...
       mlab=" ")
op <- par(cex=.75, font=2)
text(c(-9.5,-8,-6,-4.5,-2.5), 32, c("M", "SD", "M", "SD", "N")) #6 denotes the height,posy
text(c(-8.75,-5.25),     33, c("Baseline", "Peak"))
par(op) # resets the plotting parameters.
...
dat <-escalc(measure="SMCC", ni=SC_n1i, m1i=SC_m1i, m2i=SC_m2i, sd1i=SC_sd1i, sd2i=SC_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
forest(res,xlim=c(-20,6), 
       ...
       mlab=" ")
op <- par(cex=.75, font=2)
text(c(-9.5,-8,-6,-4.5, -2.5), 9, c("M", "SD", "M", "SD", "N")) #6 denotes the height,posy
text(c(-8.75,-5.25),     9.6, c("Baseline", "Peak"))
par(op) # resets the plotting parameters.
...
dat <-escalc(measure="SMCC", ni=DBP_ni, m1i=DBP_m1i, m2i=DBP_m2i, sd1i=DBP_sd1i, sd2i=DBP_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
dat <-escalc(measure="SMCC", ni=SBP_ni, m1i=SBP_m1i, m2i=SBP_m2i, sd1i=SBP_sd1i, sd2i=SBP_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
dat <-escalc(measure="SMCC", ni=RSA_ni, m1i=RSA_m1i, m2i=RSA_m2i, sd1i=RSA_sd1i, sd2i=RSA_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
dat <-escalc(measure="SMCC", ni=HRV_LF_HF_ni, m1i=HRV_LF_HF_m1i, m2i=HRV_LF_HF_m2i, sd1i=HRV_LF_HF_sd1i, sd2i=HRV_LF_HF_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
dat <-escalc(measure="SMCC", ni=HRV_RMSSD_ni, m1i=HRV_RMSSD_m1i, m2i=HRV_RMSSD_m2i, sd1i=HRV_RMSSD_sd1i, sd2i=HRV_RMSSD_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
forest(res,xlim=c(-20,6), 
       ...
       mlab=" ")
op <- par(cex=.75, font=2)
text(c(-12.5,-11,-9,-7.5, -5.5), 6.5, c("M", "SD", "M", "SD", "N")) #6 denotes the height,posy
text(c(-11.75,-8.25),     7, c("Baseline", "Peak"))
par(op) # resets the plotting parameters.
...
dat <-escalc(measure="SMCC", ni=AA_ni, m1i=AA_m1i, m2i=AA_m2i, sd1i=AA_sd1i, sd2i=AA_sd2i, ri=rep.int(0.5, 35)) #SMCC= Standardized mean change 
...
forest(res,xlim=c(-20,6), 
       ...
       mlab=" ")
op <- par(cex=.75, font=2)
text(c(-9.5,-8,-6,-4.5, -2.5), 5, c("M", "SD", "M", "SD", "N")) #6 denotes the height,posy
text(c(-8.75,-5.25),     5.5, c("Baseline", "Peak"))
par(op) # resets the plotting parameters.
