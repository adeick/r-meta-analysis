...
#Calculate SC effect size IN_PROGRESS
SC_m2i=as.numeric(unlist(select(VR_study_sprdsht,c(80))))#baseline  #select the columns you want, then convert from list to numeric array
SC_m1i=as.numeric(unlist(select(VR_study_sprdsht,c(85)))) #peak 
SC_sd2i=as.numeric(unlist(select(VR_study_sprdsht,c(81)) )) 
SC_sd1i=as.numeric(unlist(select(VR_study_sprdsht,c(86)))) 
SC_n2i=as.numeric(unlist(select(VR_study_sprdsht,c(84)))) 
SC_n1i=as.numeric(unlist(select(VR_study_sprdsht,c(89)))) 

dat <-escalc(measure="SMD", n1i=SC_n1i, n2i=SC_n2i, m1i=SC_m1i, m2i=SC_m2i, sd1i=SC_sd1i, sd2i=SC_sd2i) 
