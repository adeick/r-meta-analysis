...
HRV_LF_HF_m2i=as.numeric(unlist(select(VR_study_sprdsht,c(41))))#baseline  #select the columns you want, then convert from list to numeric array
HRV_LF_HF_m1i=as.numeric(unlist(select(VR_study_sprdsht,c(46)))) #peak #+5
HRV_LF_HF_sd2i=as.numeric(unlist(select(VR_study_sprdsht,c(42)) ))  #+1
HRV_LF_HF_sd1i=as.numeric(unlist(select(VR_study_sprdsht,c(47))))  #+6
HRV_LF_HF_ni=as.numeric(unlist(select(VR_study_sprdsht,c(50))))  #+9
...
forest(res,xlim=c(-20,10), 
       ...
       mlab=" ")
op <- par(cex=.75, font=2)
text(c(-9.5,-8,-6,-4.5, -2), 5.2, c("M", "SD", "M", "SD", "N")) #6 denotes the height,posy
text(c(-8.75,-5.25),     12.2, c("Baseline", "Peak"))
par(op) # resets the plotting parameters.
...
forest(res,xlim=c(-20,10), 
       ...
       mlab=" ")
op <- par(cex=.75, font=2)
text(c(-9.5,-8,-6,-4.5, -2), 2.2, c("M", "SD", "M", "SD", "N")) #6 denotes the height,posy
text(c(-8.75,-5.25),     12.2, c("Baseline", "Peak"))
par(op) # resets the plotting parameters.
